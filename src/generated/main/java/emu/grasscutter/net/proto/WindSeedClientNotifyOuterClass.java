...
public final class WindSeedClientNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface AddWindBulletNotifyOrBuilder extends
      ...
      /**
       * <code>uint32 add_wind_bullet_notify = 8;</code>
       * @return The addWindBulletNotify.
       */
    ...
    private static final long serialVersionUID = 0L;
      ...
      private int addWindBulletNotify_ = 0;
      /**
       * <code>uint32 add_wind_bullet_notify = 8;</code>
       * @return The addWindBulletNotify.
       */
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
                          throws java.io.IOException {
        if (addWindBulletNotify_ != 0) {
          output.writeUInt32(8, addWindBulletNotify_);
        }
        if (seedPos_ != null) {
      ...
      public int getSerializedSize() {
        ...
        if (addWindBulletNotify_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(8, addWindBulletNotify_);
        }
        if (seedPos_ != null) {
          size += com.google.protobuf.CodedOutputStream
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (getAddWindBulletNotify()
            != other.getAddWindBulletNotify()) return false;
      ...
      public int hashCode() {
        ...
        hash = (53 * hash) + getAddWindBulletNotify();
        if (hasSeedPos()) {
      ...
      public static final class Builder extends
        ...
        private void buildPartial0(emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotify result) {
          int from_bitField0_ = bitField0_;
          if (((from_bitField0_ & 0x00000001) != 0)) {
            result.addWindBulletNotify_ = addWindBulletNotify_;
          }
            ...
            while (!done) {
              ...
              switch (tag) {
                case 0:
                  ...
                  break;
                case 64: {
                  addWindBulletNotify_ = input.readUInt32();
                  bitField0_ |= 0x00000001;
                  break;
                } // case 64
                case 82: {
        ...
        /**
         * <code>uint32 add_wind_bullet_notify = 8;</code>
         * @param value The addWindBulletNotify to set.
         * @return This builder for chaining.
         */
        public Builder setAddWindBulletNotify(int value) {
          
          addWindBulletNotify_ = value;
          bitField0_ |= 0x00000001;
          onChanged();
          return this;
        }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "otify\030\013 \001(\0132#.WindSeedClientNotify.Refre" +
      "shNotifyH\000\022K\n\026add_wind_bullet_notify\030\010 \001" +
      "(\0132).WindSeedClientNotify.AddWindBulletN" +
      "otifyH\000\0227\n\013area_notify\030\002 \001(\0132 .WindSeedC" +
      "lientNotify.AreaNotifyH\000\032#\n\rRefreshNotif" +
      "y\022\022\n\nrefreshNum\030\r \001(\r\032l\n\023AddWindBulletNo" +
      "tify\022\036\n\026add_wind_bullet_notify\030\010 \001(\r\022\030\n\007" +
      "seedPos\030\n \001(\0132\007.Vector\022\033\n\023Unk3300_MPDFAP" +
      "BDJAH\030\r \001(\r\032@\n\nAreaNotify\022\020\n\010areaType\030\005 " +
      "\001(\r\022\016\n\006areaId\030\014 \001(\r\022\020\n\010areaCode\030\001 \001(\014B\010\n" +
    ...
    internal_static_WindSeedClientNotify_AddWindBulletNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_WindSeedClientNotify_AddWindBulletNotify_descriptor,
        new java.lang.String[] { "AddWindBulletNotify", "SeedPos", "Unk3300MPDFAPBDJAH", });
    internal_static_WindSeedClientNotify_AreaNotify_descriptor =
